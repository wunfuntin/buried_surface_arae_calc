...
shell_script_path = '/Users/rwalker/Documents/TT_lab/python/buried_surface_area_2/run_pisa.sh'
...
def main():
    ...
    for i in range(0, pdb_number):
        ...
        try:
            ...
            pdb1_filename = f'design_{i}.pdb'
            pdb1 = f'RFD_design_{i}.pdb'
            os.rename(pdb1_filename, pdb1)

        except FileNotFoundError:
            print(f'File design_{i}.pdb not found. Skipping to the next file')
            continue
